!(function t(e, i, n) {
...
})(
    {
            ...
            function (t, e, i) {
                !(function (i, n) {
                    ...
                    r.prototype.addElementBackgroundImages = function (t) {
                        for (var e = m(t), i = /url\(['"]*([^'"\)]+)['"]*\)/gi, n = i.exec(e.backgroundImage); null !== n;) {
                            var s = n && n[1];
        ...
        2: [
            function (t, e, i) {
                !(function (t) {
                    ...
                    "function" == typeof define && define.amd ? define(l) : "object" == typeof i ? (e.exports = l) : (t.eventie = l);
                })(window);
            },
            {},
        ],
                    ...
                    (s.getListeners = function (t) {
                        ...
                        (s.addListener = function (t, e) {
                            var n,
                                ...
                                o = "object" == typeof e;
                            for (n in s) s.hasOwnProperty(n) && -1 === i(s[n], e) && s[n].push(o ? e : { listener: e, once: !1 });
                            return this;
                        }),
                        (s.on = n("addListener")),
                        ...
                        (s.removeListener = function (t, e) {
                            ...
                            for (s in o) o.hasOwnProperty(s) && ((n = i(o[s], e)), -1 !== n && o[s].splice(n, 1));
                            return this;
                        }),
                            ...
                            for (o in l)
                                if (l.hasOwnProperty(o))
                                    for (i = l[o].slice(0), s = i.length; s--;)
                                        (n = i[s]), n.once === !0 && this.removeListener(t, n.listener), (r = n.listener.apply(this, e || [])), r === this._getOnceReturnValue() && this.removeListener(t, n.listener);
                            return this;
                        }),
            ...
            function (t, e, i) {
                !(function (t, n) {
                    ...
                    function e() {
                        ...
                        return (c.innerHTML = s), (f.innerHTML = r), (m.innerHTML = o), i.appendChild(c), l.appendChild(f), h.appendChild(m), e;
                    }
                    var i = {},
                        n = {
        ...
        6: [
            function (t, e, i) {
                !(function (n, s) {
                    "function" == typeof define && define.amd
                        ? define(s)
                        : "object" == typeof i
                            ? (e.exports = s(t("imagesLoaded"), t("./vendor/google-image-layout"), t("./create-controls")))
                    ...
                    var c,
                        f = { transition: "transitionend", WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "otransitionend" },
                        a = document.createElement("div");
                    for (var m in f)
                    ...
                    return (
                        ...
                        (s.prototype._bindEvents = function () {
                            for (var t = 0, e = this._thumbs.length; e > t; t++)
                                this._thumbs[t].addEventListener("click", this._handleThumbClick.bind(this)), this._thumbs[t].addEventListener("mouseover", this._handleThumbHover.bind(this));
                        ...
                        (s.prototype._loadFullImgs = function () {
                            for (var t, e, i = 0, n = this._thumbs.length; n > i; i++)
                                (t = this._thumbs[i].getAttribute("data-full")), (e = new Image()), (e.src = t), e.classList.add(this._cssClasses.FULL_IMG), this._fullBox.appendChild(e);
                        ...
                        (s.prototype._transformFullImg = function (t, e, i) {
                            ...
                            (t = t.getBoundingClientRect()),
                                ...
                                i
                                    ? ((n = (e.width / i.width).toFixed(3)), (s = (e.height / i.height).toFixed(3)), (o = e.left - i.left + i.width / 2), (r = e.top - i.top + i.height / 2))
                                    : ((n = (e.width / t.width).toFixed(3)), (s = (e.height / t.height).toFixed(3)), (o = e.left - t.left + t.width / 2), (r = e.top - t.top + t.height / 2));
                        ...
                        (s.prototype._resetFullImg = function () {
                            ...
                            for (var t = 0, e = this._fullImgs.length; e > t; t++) {
                                ({ width: this._fullImgDimensions[t].width, height: this._fullImgDimensions[t].height, left: this._fullImgDimensions[t].left, top: this._fullImgDimensions[t].top });
                                t === this._thumbIndex && this._fullImgOpen
                                    ? (this._fullImgs[t].removeAttribute("style"), this._positionFullImgs.call(this, this._fullImgs[t], t, !1))
                                    : (this._fullImgs[t].removeAttribute("style"), this._positionFullImgs.call(this, this._fullImgs[t], t));
                            }
                        }),
                        ...
                        (s.prototype._handleThumbClick = function (t) {
                            this._thumb != t.target && ((this._thumb = t.target), (this._thumbIndex = this._thumbs.indexOf(this._thumb)), (this._fullImg = this._fullImgs[this._thumbIndex])),
                                this._setupComplete &&
                                this._fullImgsLoaded &&
                                !this._fullImgOpen &&
                                (this._activateFullImg.call(this), this._activateControls.call(this), this._activateFullBox.call(this));
                        }),
            ...
            { "./create-controls": 4, "./vendor/google-image-layout": 7, imagesLoaded: 1 },
        ],
        7: [
            function (t, e, i) {
                !(function (t, n) {
                    ...
                    var e = {},
                        ...
                        o = function (t, e, i) {
                            for (var n, s = 0, o = 0; o < t.length; o++) (n = t[o]), (s += parseInt(n.getAttribute("data-width")) / parseInt(n.getAttribute("data-height")));
                            return e / s;
                        },
                        r = function (t, e) {
                            i.push(e);
                            for (var n, s = 0; s < t.length; s++)
                                (n = t[s]),
                                    (n.style.width = (e * parseInt(n.getAttribute("data-width"))) / parseInt(n.getAttribute("data-height")) + "px"),
                                    (n.style.height = e + "px"),
                    ...
                    return (
                        (e.init = function (t) {
                            t = t || {};
                            for (var i, n = document.querySelectorAll("div[data-google-image-layout]"), s = n.length, o = 0; s > o; o++) (i = n[o]), e.align(i);
                            t.after && t.after();
                        }),
                        (e.align = function (t) {
                            var e = t.clientWidth,
